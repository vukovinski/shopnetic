        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IPAddress = table.Column<string>(type: "text", nullable: false),
                    CartOwnerType = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: false),
                    UserSessionId = table.Column<Guid>(type: "uuid", nullable: true),
                    UserId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartOwners", x => x.CartOwnerId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CartOwners_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CartOwnerId = table.Column<int>(type: "integer", nullable: false),
                    CartContentsJson = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_CartOwners_CartOwnerId",
                        column: x => x.CartOwnerId,
                        principalTable: "CartOwners",
                        principalColumn: "CartOwnerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectiveFrom = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    EffectiveTo = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    DiscountType = table.Column<string>(type: "character varying(8)", maxLength: 8, nullable: false),
                    CartId = table.Column<int>(type: "integer", nullable: true),
                    DiscountAmount = table.Column<decimal>(type: "numeric", nullable: true),
                    ProductId = table.Column<int>(type: "integer", nullable: true),
                    ProductDiscount_DiscountAmount = table.Column<decimal>(type: "numeric", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Discounts", x => x.DiscountId);
                    table.ForeignKey(
                        name: "FK_Discounts_Carts_CartId",
                        column: x => x.CartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_CartOwners_CartOwnerId",
                        column: x => x.CartOwnerId,
                        principalTable: "CartOwners",
                        principalColumn: "CartOwnerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CartOwnerId",
                table: "Orders",
                column: "CartOwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_Payments_CartOwnerId",
                table: "Payments",
                column: "CartOwnerId");
