...
namespace Shopnetic.Shared.Migrations
{
    ...
    [Migration("20250708140603_RemovedUserSessions")]
    partial class RemovedUserSessions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shopnetic.Shared.Database.Category", b =>
                {
                    ...
                    b.Property<string>("CategoryImageMimeType")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Shopnetic.Shared.Database.Order", b =>
                {
                    ...
                    b.OwnsOne("Shopnetic.Shared.Database.ShippingAddress", "ShippingAddress", b1 =>
                        {
